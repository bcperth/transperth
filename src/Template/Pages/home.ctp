...
if (!Configure::read('debug')) :
    throw new NotFoundException(
        'Please replace src/Template/Pages/cakeconfig.ctp with your own version or re-enable debug mode.'
    );
endif;
...
<div class="row">
    <div class="columns large-6">
        ...
        <ul>
            <li class="bullet cutlery">To change the content of this page, edit: src/Template/Pages/cakeconfig.ctp.</li>
